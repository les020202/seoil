...
console.log(obj.name);//객체 안 접근방법
console.log(obj["name"]);//객체 안 접근방법

//json 형식
let strobj='{"name":"hongkildong","age":"30"}';
// let strobj2="{"name":"hongkildong","age":"30"}";  // 오류발생
let strobj3="{\"name\":\"hongkildong\",\"age\":\"30\"}"; // ""쓸려면 안의 "을 \"로 바꾼다
console.log(strobj.name);  //undefined 출력
//js문자열 표현방법
let str="hello";
let str2='hello';
...
let obj4=JSON.parse(strobj);  //json 형식의 문자열을 객체로 변환
...
//객체의 조합
//속성만을 사용한 객체 -> let obj={"name":"hongkildong","age":23} 
//속성+함수
let obj5={
    "name":"hongkildong", "age":"30", "callname":function(name){console.log(name)}, "callage":function(age){console.log(age)}
} 
...
let obj6 ={
    "name":"kim", //속성
    "age":"10",
    "intro":function(name,age,fav){ //함수
        console.log(`my name is ${name}`);
        console.log(`my age is ${age}`);
        console.log(`my fav is ${fav}`);
    },
    "fav":["apple","banana","mango"], //배열
